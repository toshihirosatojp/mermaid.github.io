		...
		<div id="col1">
			...
			<Card title='Links'>
				<ul className='marketing-links' class="marketing-links">
					...
					<li>
						<a href="https://marketplace.atlassian.com/apps/1222792/mermaid-integration-for-confluence" target="_blank">
							Mermaid Integration for Confluence
						</a>
					</li> 
					<li>
						<a href="https://toshihiro.atlassian.net/wiki/spaces/MIFC/overview" target="_blank">
								Mermaid Integration Documentation
						</a>
					</li>
				</ul>
			</Card>
